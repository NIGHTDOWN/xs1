...
public class GooglePay {
            ...
            public void onPurchasesUpdated(List<Purchase> purchases) {
                ...
                if (purchases != null && purchases.size() > 0) {
                    ...
                    for (Purchase purchase : purchases) {
                        ...
                        // 这里是vip
                        // BillingUtil.getInstance().consumeAsyncs(consumeParams);
    ...
    public static void startgoogleBuy(String sku, String payload) {
        ...
        String type = BillingClient.SkuType.INAPP;
        BillingUtil.getInstance().querySkuDetailsAsync(type, skuList, (billingResult, skuDetailsList) -> {
